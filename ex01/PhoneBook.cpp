...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/02 14:34:26 by ivloisy           #+#    #+#             */
/*   Updated: 2022/01/04 01:37:52 by ivloisy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	PhoneBook::printContact(void)
{
	...
	std::cout << "\nFirst name :\t\t" << this->_contact[index].getInfo(0) << std::endl;
	std::cout << "Last name :\t\t" << this->_contact[index].getInfo(1) << std::endl;
	std::cout << "Nickname :\t\t" << this->_contact[index].getInfo(2) << std::endl; 
	std::cout << "Phone number :\t\t" << this->_contact[index].getInfo(3) << std::endl; 
	std::cout << "Darkest secret :\t" << this->_contact[index].getInfo(4) << std::endl
	<< std::endl; 
}
...
int	PhoneBook::chooseContact(void)
{
	...
	while (!r)
	{
		...
		if ((!strncmp(s, "1", 1) || !strncmp(s, "2", 1) || !strncmp(s, "3", 1)
				|| !strncmp(s, "4", 1) || !strncmp(s, "5", 1) || !strncmp(s, "6", 1)
				|| !strncmp(s, "7", 1) || !strncmp(s, "8", 1))
